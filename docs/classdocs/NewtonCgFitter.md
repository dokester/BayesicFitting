...
<a name="NewtonCgFitter"></a>
<table><thead style="background-color:#FFE0E0; width:100%"><tr><th style="text-align:left; font-size:20px">
<strong>class NewtonCgFitter(</strong> <a href="./ScipyFitter.html">ScipyFitter</a> )</th><th style="text-align:right; font-size:12px"><a href=https://github.com/dokester/BayesicFitting/blob/master/BayesicFitting/source/ScipyFitter.py target=_blank>[source]</a></th></tr></thead></table>
<p>

Truncated Newton method

Syntactic sugar for
<br>&nbsp;&nbsp;&nbsp;&nbsp; ScipyFitter( ..., method='NEWTON-CG', ... )
...
<strong>NewtonCgFitter(</strong> xdata, model, gradient=True, **kwargs ) 
</th><th style="text-align:right; font-size:12px"><a href=https://github.com/dokester/BayesicFitting/blob/master/BayesicFitting/source/ScipyFitter.py#L537-L562 target=_blank>[source]</a></th></tr></thead></table>
