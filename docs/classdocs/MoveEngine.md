...
<strong>copy(</strong> )
</th><th style="text-align:right; font-size:12px"><a href=https://github.com/dokester/BayesicFitting/blob/master/BayesicFitting/source/MoveEngine.py#L69-L72 target=_blank>[source]</a></th></tr></thead></table>
