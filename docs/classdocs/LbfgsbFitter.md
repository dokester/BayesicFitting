...
<strong>class LbfgsbFitter(</strong> <a href="./ScipyFitter.html">ScipyFitter</a> )</th><th style="text-align:right; font-size:12px"><a href=https://github.com/dokester/BayesicFitting/blob/master/BayesicFitting/source/ScipyFitter.py target=_blank>[source]</a></th></tr></thead></table>
<p>

Limited Memory Algorithm for Bound Constrained Optimization

Syntactic sugar for
<br>&nbsp;&nbsp;&nbsp;&nbsp; ScipyFitter( ..., method='L-BFGS-B', ... )
...
</th><th style="text-align:right; font-size:12px"><a href=https://github.com/dokester/BayesicFitting/blob/master/BayesicFitting/source/ScipyFitter.py#L574-L599 target=_blank>[source]</a></th></tr></thead></table>
