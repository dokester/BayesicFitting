...
<strong>class TncFitter(</strong> <a href="./ScipyFitter.html">ScipyFitter</a> )</th><th style="text-align:right; font-size:12px"><a href=https://github.com/dokester/BayesicFitting/blob/master/BayesicFitting/source/ScipyFitter.py target=_blank>[source]</a></th></tr></thead></table>
<p>

Truncated Newton method with limits.

Syntactic sugar for
<br>&nbsp;&nbsp;&nbsp;&nbsp; ScipyFitter( ..., method='TNC', ... )
...
<strong>TncFitter(</strong> xdata, model, gradient=True, **kwargs ) 
</th><th style="text-align:right; font-size:12px"><a href=https://github.com/dokester/BayesicFitting/blob/master/BayesicFitting/source/ScipyFitter.py#L611-L636 target=_blank>[source]</a></th></tr></thead></table>
