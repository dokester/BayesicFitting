...
mdl-I-1 : a model with n dim inputs and 1 dim outputs<br>
mdl-1-O : a model with 1 dim inputs and k dim outputs<br>
mdl-I-O : a model with n dim inputs and k dim outputs<br>
<p>
