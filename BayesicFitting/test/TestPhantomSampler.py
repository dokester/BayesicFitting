# run with : python3 -m unittest TestPhantomSampler
# or :       python3 -m unittest TestPhantomSampler.TestPhantomSampler.test1
...
#from BayesicFitting import PhantomSampler1 as PhantomSampler
...
class TestPhantomSampler( unittest.TestCase ):
    """
    ...
    def test1( self ):
        ...
        ns = PhantomSampler( x, gm, y, w, threads=True, engines=["galilean", "gibbs"] )
#        ns.verbose = 4
...
#        print( "Elapsed ", endt - start )
    ...
    def test4( self ):
        ...
        for N in [10, 40, 160, 640, 2560] :
            ...
            ns = PhantomSampler( x, pm, y, verbose=0 )
            ns.distribution.setLimits( [0.01, 100] )
...
#        assertAAE( par, pp, 2 )
    ...
    @classmethod
    def suite( cls ):
        return unittest.TestCase.suite( PhantomSampler1Test.__class__ )
