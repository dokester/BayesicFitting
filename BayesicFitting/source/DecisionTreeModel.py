...
class DecisionTreeModel( Modifiable, Dynamic, LinearModel ):
    ...
    def __init__( self, ndim=1, depth=0, split=0.5, kdim=0, itypes=[0], modifiable=True,
        ...
        param = [0.0] * nparams
#        super( DecisionTreeModel, self ).__init__( nparams, ndim=ndim, copy=copy,
...
#            self.setPrior( 0, prior=UniformPrior( limits=[0.0,1.0] ) )
            self.setLimits( 0, 1 )
        else :
